var SarvamWidget = function(exports) {
...
var __publicField = (obj, key, value) => __defNormalProp(obj, typeof key !== "symbol" ? key + "" : key, value);
  ...
  const ChatButton = ({ isOpen, onClick, primaryColor }) => {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        ...
        children: isOpen ? (
          // Close icon (X)
          /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { className: "chat-button-icon", viewBox: "0 0 24 24", children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M18 6L6 18M6 6L18 18", stroke: "currentColor", strokeWidth: 2, strokeLinecap: "round", strokeLinejoin: "round", fill: "none" }) })
        ) : (
          // Chat icon
          /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { className: "chat-button-icon", viewBox: "0 0 24 24", children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M21 15a2 2 0 01-2 2H7l-4 4V5a2 2 0 012-2h14a2 2 0 012 2z", stroke: "currentColor", strokeWidth: 2, strokeLinecap: "round", strokeLinejoin: "round", fill: "none" }) })
        )
      }
    );
  };
  let sessionId = "default";
  let currentContext = "You are a helpful assistant.";
  ...
  async function sendMessageToGemini(message) {
    ...
    try {
      ...
      return data.response || "I apologize, but I didn't receive a proper response.";
    } catch (error) {
      ...
      return `I apologize, but I'm having trouble connecting to my AI service right now. Please try again in a moment. Error: ${error == null ? void 0 : error.message}`;
    }
  }
  ...
  function saveChatHistory(messages, context) {
    try {
      const history = {
  ...
  class VoiceRecorder {
    ...
    startRecording(onResult, onError, onStart, onEnd) {
      if (!this.isSupported) {
  ...
  function getLanguagePrompt(languageCode) {
    return LANGUAGE_PROMPTS[languageCode] || LANGUAGE_PROMPTS.en;
  }
  function getVoiceCode(languageCode, languages) {
    const lang = languages.find((l2) => l2.code === languageCode);
  ...
  const ChatWindow = ({
    ...
    const [hasContextMemory, setHasContextMemory] = reactExports.useState(false);
    ...
    const [isVoiceSupported, setIsVoiceSupported] = reactExports.useState(false);
    const [currentLanguage, setCurrentLanguage] = reactExports.useState(defaultLanguage);
    const messagesEndRef = reactExports.useRef(null);
    const inputRef = reactExports.useRef(null);
    reactExports.useEffect(() => {
      if (!isInitialized) {
        const savedLang = loadLanguagePreference();
        if (savedLang && supportedLanguages.find((l2) => l2.code === savedLang)) {
          setCurrentLanguage(savedLang);
        }
        initializeChat();
        setIsInitialized(true);
        const voiceRecorder2 = getVoiceRecorder();
        setIsVoiceSupported(voiceRecorder2.isVoiceSupported());
    ...
    const initializeChat = () => {
      ...
      if (storedHistory && storedHistory.messages.length > 0 && storedHistory.context === context) {
        const uiMessages = storedHistory.messages.map((msg) => ({
          id: msg.id,
    ...
    const saveMessagesToStorage = (allMessages) => {
      const messagesToSave = allMessages.length === 1 && allMessages[0].id === "1" ? [] : allMessages.filter((msg) => msg.id !== "1").map((msg) => ({
        id: msg.id,
...
${transcribedText}`;
  ...
  function getWidgetConfig() {
    ...
    return {
      ...
      theme: {
        primaryColor: ((_a = userConfig.theme) == null ? void 0 : _a.primaryColor) || defaultConfig.theme.primaryColor,
        backgroundColor: ((_b = userConfig.theme) == null ? void 0 : _b.backgroundColor) || defaultConfig.theme.backgroundColor,
        textColor: ((_c = userConfig.theme) == null ? void 0 : _c.textColor) || defaultConfig.theme.textColor
      },
      agent: {
        name: ((_d = userConfig.agent) == null ? void 0 : _d.name) || defaultConfig.agent.name,
        avatar: ((_e = userConfig.agent) == null ? void 0 : _e.avatar) || defaultConfig.agent.avatar
      },
      enableVoice: userConfig.enableVoice !== void 0 ? userConfig.enableVoice : defaultConfig.enableVoice,
  ...
  const Widget = () => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "widget-container", style: positionStyles, children: [
...
`;
  ...
  function initWidget() {
    ...
    widgetInstance = new SarvamWidget2();
    return widgetInstance;
  }
  const SarvamWidgetAPI = {
    ...
    show: () => widgetInstance == null ? void 0 : widgetInstance.show(),
    hide: () => widgetInstance == null ? void 0 : widgetInstance.hide(),
    getInstance: () => widgetInstance
  };
  window.SarvamWidget = SarvamWidgetAPI;
  initWidget();
  exports.SarvamWidget = SarvamWidget2;
  exports.SarvamWidgetAPI = SarvamWidgetAPI;
  exports.default = SarvamWidgetAPI;
