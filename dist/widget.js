      ...
      .then((result) => {
        ...
        if (isValidResponse(result.response)) {
          ...
          const responseContent = Object.assign(
            ...
            (_a2 = result.response.candidates) === null || _a2 === void 0
              ? void 0
              : _a2[0].content
          );
...
async function sendMessageToGemini(message) {
  ...
  try {
    ...
    return `Sorry, I encountered an error: ${
      (error == null ? void 0 : error.message) || "Could not reach Gemini API"
    }`;
  }
}
...
const ChatWindow = ({
  ...
  const [currentLanguage, setCurrentLanguage] =
    reactExports.useState(defaultLanguage);
  ...
  const saveMessagesToStorage = (allMessages) => {
    const messagesToSave =
      allMessages.length === 1 && allMessages[0].id === "1"
        ? []
        : allMessages
            .filter((msg) => msg.id !== "1")
            .map((msg) => ({
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("select", {
                ...
                children: supportedLanguages.map((lang) =>
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "option",
                    { value: lang.code, children: lang.nativeName },
                    lang.code
                  )
                ),
              }),
...
function getWidgetConfig() {
  ...
  return {
    ...
    theme: {
      primaryColor:
        ((_a = userConfig.theme) == null ? void 0 : _a.primaryColor) ||
        defaultConfig.theme.primaryColor,
      backgroundColor:
        ((_b = userConfig.theme) == null ? void 0 : _b.backgroundColor) ||
        defaultConfig.theme.backgroundColor,
      textColor:
        ((_c = userConfig.theme) == null ? void 0 : _c.textColor) ||
        defaultConfig.theme.textColor,
    },
    agent: {
      name:
        ((_d = userConfig.agent) == null ? void 0 : _d.name) ||
        defaultConfig.agent.name,
      avatar:
        ((_e = userConfig.agent) == null ? void 0 : _e.avatar) ||
        defaultConfig.agent.avatar,
    },
    enableVoice:
      userConfig.enableVoice !== void 0
        ? userConfig.enableVoice
        : defaultConfig.enableVoice,
    context: userConfig.context || defaultConfig.context,
    supportedLanguages:
      userConfig.supportedLanguages || defaultConfig.supportedLanguages,
    defaultLanguage:
      userConfig.defaultLanguage || defaultConfig.defaultLanguage,
  };
}
